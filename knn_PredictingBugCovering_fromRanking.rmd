...
##Testing the model
```{r test.knn.cv.class, include=FALSE}
...
<p>Maximum ranking vote of the questions categorized as bug covering:</p>
...
ggplot(data=predictedList.df, aes(x=predictedList.df$votes)) +
  ...
  labs(x="Ranking vote of the questions categorized as bug-covering. Mininal vote=3, mean=1.71", 
       y="Frequency");
